...
//    mDragController3 = new DragController(this);
...
//    drop2.setup (mDragLayer2, dragController, R.color.drop_target_color2);
    
    DropSpot drop3 = (DropSpot) mDragLayer.findViewById (R.id.drop_spot3);
//    drop2.setup (mDragLayer3, dragController, R.color.drop_target_color2);
